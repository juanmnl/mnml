	...
	$('form#contact-form').submit(function() {
		...
		if(!hasError) {
			...
			$.post($(this).attr('action'),formInput, function(data){
				$("form#contact-form").before('<div class="contact-success"><strong>THANK YOU!</strong><p>Thank you! Your email was successfully sent. I will contact you as soon as possible.</p></div>');
			});
		}
